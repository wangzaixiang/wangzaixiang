...
**
** CSlot is a "fan.compiler slot" which is represents a Slot in the
** fan.compiler.  CSlots unifies slots being compiled as SlotDefs
...
**
** CField is a "fan.compiler field" which is represents a Field in the
** fan.compiler.  CFields unify methods being compiled as FieldDefs
...
**
** CMethod is a "fan.compiler method" which is represents a Method in the
** fan.compiler.  CMethods unify methods being compiled as MethodDefs
...
**
** CParam models a MethodParam in the fan.compiler.  CParams unify the params
