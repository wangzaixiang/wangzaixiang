...
//////////////////////////////////////////////////////////////////////////
  ...
  new make(Compiler fan.compiler, Location location, FPod fpod, MethodDef? curMethod)
    : super(fan.compiler)
  {
...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void breakOrContinueStmt(Stmt stmt)
  {
    ...
    if (loop.stmt !== stmt->loop)
      throw err("Internal fan.compiler error", stmt.location)
  ...
  **
  private Void assign(BinaryExpr expr)
  {
    switch (expr.lhs.id)
    {
      ...
      default: throw err("Internal fan.compiler error", expr.location)
    }
  }
