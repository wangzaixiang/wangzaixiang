...
** for errors the fan.compiler can detect such as invalid type usage.  We
...
//////////////////////////////////////////////////////////////////////////
  ...
  override Void visitTypeDef(TypeDef t)
  {
    ...
    if (t.slotDef("type") != null && !fan.compiler.isSys)
...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void checkCtor(MethodDef m)
  {
    ...
    if (m.ctorChain == null && !fan.compiler.isSys && !curType.base.isObj && !curType.isSynthetic)
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** Check if field is assignable, return new rhs.
  ...
  private Void checkTypeCheck(TypeCheckExpr expr)
  {
    ...
    // fan.compiler generated itself (which is most coercions)
