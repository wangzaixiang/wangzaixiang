...
**
** CompilerLog manages logging fan.compiler messages.  The default
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ...
  {
    log(LogRecord(DateTime.now, LogLevel.error, "fan.compiler", msg, err))
  }
  ...
  **
  ...
  {
    log(LogRecord(DateTime.now, LogLevel.warn, "fan.compiler", msg, err))
  }
  ...
  **
  ...
  {
    log(LogRecord(DateTime.now, LogLevel.info, "fan.compiler", msg, err))
  }
  ...
  **
  ...
  {
    log(LogRecord(DateTime.now, LogLevel.debug, "fan.compiler", msg, err))
  }
