...
//////////////////////////////////////////////////////////////////////////
  ...
  ** Constructor
  **
  new make(Compiler fan.compiler, TypeDef curType, Int curryCount, CurryExpr expr)
    : super(fan.compiler)
  {
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  Expr mapCurry()
  {
    ...
    // Method.callX()
    InitClosures.genMethodCall(fan.compiler, loc, curry, sig, doCall, thisIsParam)

    // generate isImmutable method
    InitClosures.genIsImmutableMethod(fan.compiler, loc, curry, allArgsConst)
