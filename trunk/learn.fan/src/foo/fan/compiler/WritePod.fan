...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  File write()
  {
    dir  := fan.compiler.input.outDir
    fpod := fan.compiler.fpod
    ...
    try
    {
      ...
      if (!fan.compiler.input.isScript)
        writeTypeDb(zip)

      // write resource files
      fan.compiler.resFiles.each |File f| { writeRes(zip, f) }

      // if including fandoc write it out too
      if (fan.compiler.input.includeDoc) writeTypeDocs(zip)

      // if including source write it out too
      if (fan.compiler.input.includeSrc) writeSrc(zip)
    }
    catch (CompilerErr e)
    {
      throw e
...
//////////////////////////////////////////////////////////////////////////
  ...
  {
    fan.compiler.types.each |TypeDef t|
    {
...
//////////////////////////////////////////////////////////////////////////
  ...
  {
    fan.compiler.srcFiles.each |File f|
    {
...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void writeTypeDb(Zip zip)
  {
    ...
    out.writeUtf(fan.compiler.fpod.version.toStr)
    ...
    podFacets := fan.compiler.input.podFacets
