...
//////////////////////////////////////////////////////////////////////////
  ...
  {
    log.debug("Closures")
    fan.compiler.closures.each |ClosureExpr c| { process(c) }
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void genIsImmutable()
  {
    ...
    genIsImmutableMethod(fan.compiler, loc, cls, true)
  }

  static internal Void genIsImmutableMethod(Compiler fan.compiler, Location loc, TypeDef parent, Bool literalVal)
  {
    Expr literal := literalVal ?
       LiteralExpr.make(loc, ExprId.trueLiteral, fan.compiler.ns.boolType, true) :
       LiteralExpr.make(loc, ExprId.falseLiteral, fan.compiler.ns.boolType, false)
    ...
    m.name = "isImmutable"
    m.ret  = fan.compiler.ns.boolType
    m.code = code
    parent.addSlot(m)
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void genCall()
  {
    ...
    genMethodCall(fan.compiler, loc, cls, signature, c, false)
  }
  ...
  **
  static MethodDef genMethodCall(Compiler fan.compiler, Location loc, TypeDef parent,
