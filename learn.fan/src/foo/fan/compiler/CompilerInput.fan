...
**
** CompilerInput encapsulates all the input needed run the fan.compiler.
** The fan.compiler can be run in one of two modes - file or str.  In
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** fan.compiler checking and output in the pod's manifest.
  **
  ...
  ** use the fan.compiler's own pod definitions via reflection (which
  ** is more efficient).
  **
  File? dependsDir := null

  **
  ** What type of output should be generated - the fan.compiler
