...
** used during the fan.compiler pipeline.
**
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ** Get the fan.compiler.
  **
  virtual Compiler fan.compiler() { c }

  **
  ** Convenience for fan.compiler.ns
  **
  CNamespace ns()
  {
    return c.ns
  ...
  **
  ** Convenience for fan.compiler.pod
  **
  PodDef pod()
  {
    return c.pod
  ...
  **
  ** Convenience for fan.compiler.pod.units
  **
  ...
  **
  ** Convenience for fan.compiler.types
  **
  TypeDef[] types()
  {
    return c.types
  ...
  **
  ** Convenience for fan.compiler.log
  **
  CompilerLog log()
  {
    return c.log
...
//////////////////////////////////////////////////////////////////////////
  ...
  private Compiler c           // parent fan.compiler instance
