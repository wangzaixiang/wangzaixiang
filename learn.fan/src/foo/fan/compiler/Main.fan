...
**
** Main is the main entry point for the Fan fan.compiler.  It handles
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ** Main entry point for fan.compiler.
  **
  Int run(Str[] args)
  {
    t1 := Duration.now
    ...
    {
      log.compilerErr(CompilerErr.make("Internal fan.compiler error", null, err));
      err.trace
      success = false;
    }
